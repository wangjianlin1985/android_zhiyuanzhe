...
public class UserInfoService {
	...
	public String AddUserInfo(UserInfo userInfo) {
		...
		params.put("specialInfo", userInfo.getSpecialInfo());
		params.put("nation", userInfo.getNation());
		params.put("politicalStatus", userInfo.getPoliticalStatus());
		...
		params.put("interest", userInfo.getInterest());
		params.put("introduce", userInfo.getIntroduce());
	...
	public List<UserInfo> QueryUserInfo(UserInfo queryConditionUserInfo) throws Exception {
		...
		if(queryConditionUserInfo != null) {
			...
			urlString += "&email=" + URLEncoder.encode(queryConditionUserInfo.getEmail(), "UTF-8") + "";
			...
			urlString += "&specialInfo=" + URLEncoder.encode(queryConditionUserInfo.getSpecialInfo(), "UTF-8") + "";
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				...
				userInfo.setSpecialInfo(object.getString("specialInfo"));
				userInfo.setNation(object.getString("nation"));
				userInfo.setPoliticalStatus(object.getString("politicalStatus"));
				...
				userInfo.setInterest(object.getString("interest"));
				userInfo.setIntroduce(object.getString("introduce"));
