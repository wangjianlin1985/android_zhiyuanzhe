...
/*需要绑定的数据*/
  ...
  public View getView(int position, View convertView, ViewGroup parent) { 
	  ...
	  holder.tv_schoolName = (TextView)convertView.findViewById(R.id.tv_schoolName);
	  holder.tv_specialInfo = (TextView)convertView.findViewById(R.id.tv_specialInfo);
	  holder.tv_nation = (TextView)convertView.findViewById(R.id.tv_nation);
	  ...
	  holder.tv_email.setText("邮箱：" + mData.get(position).get("email").toString());
	  ...
	  holder.tv_schoolName.setText("学校学院：" + mData.get(position).get("schoolName").toString());
	  holder.tv_specialInfo.setText("年级专业：" + mData.get(position).get("specialInfo").toString());
	  holder.tv_nation.setText("民族：" + mData.get(position).get("nation").toString());
