			...
			public void onClick(View v) {
				try {
					...
					if(ET_comeFrom.getText().toString().equals("")) {
						Toast.makeText(NewsAddActivity.this, "来源输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_newsContent.getText().toString().equals("")) {
						Toast.makeText(NewsAddActivity.this, "内容输入不能为空!", Toast.LENGTH_LONG).show();
					...
					/*调用业务逻辑层上传活动新闻信息*/
					NewsAddActivity.this.setTitle("正在上传活动新闻信息，稍等...");
