				...
				handler.post(new Runnable() {
					...
					public void run() {
						...
						adapter = new UserInfoSimpleAdapter(UserInfoListActivity.this, list,
	        					...
	        					new String[] { "user_name","email","name","sex","userPhoto","schoolName","specialInfo","nation","birthday","telephone" },
	        					new int[] { R.id.tv_user_name,R.id.tv_email,R.id.tv_name,R.id.tv_sex,R.id.iv_userPhoto,R.id.tv_schoolName,R.id.tv_specialInfo,R.id.tv_nation,R.id.tv_birthday,R.id.tv_telephone,},lv);
	...
	private List<Map<String, Object>> getDatas() {
		...
		try {
			...
			for (int i = 0; i < userInfoList.size(); i++) {
				...
				map.put("email", userInfoList.get(i).getEmail());
				...
				map.put("schoolName", userInfoList.get(i).getSchoolName());
				map.put("specialInfo", userInfoList.get(i).getSpecialInfo());
				map.put("nation", userInfoList.get(i).getNation());
