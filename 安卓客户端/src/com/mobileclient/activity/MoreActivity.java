...
public class MoreActivity extends Activity {
	private String[] strs = new String[]{"活动报名","审核状态","活动新闻","修改个人信息","关于"};
		...
		list.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				// TODO Auto-generated method stub
								if(arg2 == 0){
					Intent intent  = new Intent(MoreActivity.this, SignUpListActivity.class);
					startActivity(intent);
				}
				if(arg2 == 1){
					Intent intent  = new Intent(MoreActivity.this, SignUpSateListActivity.class);
					startActivity(intent);
				}
				if(arg2 == 2){
