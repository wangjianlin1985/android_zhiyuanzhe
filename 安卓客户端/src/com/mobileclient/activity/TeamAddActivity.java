	...
	public void onCreate(Bundle savedInstanceState) {
		...
		btnAdd.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				try {
					/*验证获取用户名*/
					if(ET_teamUserName.getText().toString().equals("")) {
						Toast.makeText(TeamAddActivity.this, "用户名输入不能为空!", Toast.LENGTH_LONG).show();
						ET_teamUserName.setFocusable(true);
						ET_teamUserName.requestFocus();
						return;
					}
					team.setTeamUserName(ET_teamUserName.getText().toString());
					/*验证获取登录密码*/ 
					if(ET_password.getText().toString().equals("")) {
						Toast.makeText(TeamAddActivity.this, "登录密码输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_email.getText().toString().equals("")) {
						Toast.makeText(TeamAddActivity.this, "电子邮箱输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_teamName.getText().toString().equals("")) {
						Toast.makeText(TeamAddActivity.this, "志愿团体名称输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_shoolName.getText().toString().equals("")) {
						Toast.makeText(TeamAddActivity.this, "所属院校输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_contactGroup.getText().toString().equals("")) {
						Toast.makeText(TeamAddActivity.this, "联络团体输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_mainUnit.getText().toString().equals("")) {
						Toast.makeText(TeamAddActivity.this, "主管单位输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_area.getText().toString().equals("")) {
						Toast.makeText(TeamAddActivity.this, "区域输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_address.getText().toString().equals("")) {
						Toast.makeText(TeamAddActivity.this, "详细地址输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_postCode.getText().toString().equals("")) {
						Toast.makeText(TeamAddActivity.this, "邮编输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_personNum.getText().toString().equals("")) {
						Toast.makeText(TeamAddActivity.this, "志愿者人数输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_telephone.getText().toString().equals("")) {
						Toast.makeText(TeamAddActivity.this, "联系人电话输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_chargeMan.getText().toString().equals("")) {
						Toast.makeText(TeamAddActivity.this, "负责人姓名输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_cardNumber.getText().toString().equals("")) {
						Toast.makeText(TeamAddActivity.this, "负责人身份证输入不能为空!", Toast.LENGTH_LONG).show();
					...
					/*调用业务逻辑层上传团队信息*/
					TeamAddActivity.this.setTitle("正在上传团队信息，稍等...");
