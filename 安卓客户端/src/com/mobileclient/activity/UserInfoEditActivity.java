...
public class UserInfoEditActivity extends Activity {
			...
			public void onClick(View v) {
				try {
					...
					if(ET_schoolName.getText().toString().equals("")) {
						Toast.makeText(UserInfoEditActivity.this, "学校学院输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_specialInfo.getText().toString().equals("")) {
						Toast.makeText(UserInfoEditActivity.this, "年级专业输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_nation.getText().toString().equals("")) {
						Toast.makeText(UserInfoEditActivity.this, "民族输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_politicalStatus.getText().toString().equals("")) {
						Toast.makeText(UserInfoEditActivity.this, "政治面貌输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_cardNumber.getText().toString().equals("")) {
						Toast.makeText(UserInfoEditActivity.this, "证件号码输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_address.getText().toString().equals("")) {
						Toast.makeText(UserInfoEditActivity.this, "联系地址输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_interest.getText().toString().equals("")) {
						Toast.makeText(UserInfoEditActivity.this, "有兴趣的项目输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_introduce.getText().toString().equals("")) {
						Toast.makeText(UserInfoEditActivity.this, "个人介绍输入不能为空!", Toast.LENGTH_LONG).show();
	...
	private void initViewData() {
		...
		this.ET_specialInfo.setText(userInfo.getSpecialInfo());
		this.ET_nation.setText(userInfo.getNation());
		this.ET_politicalStatus.setText(userInfo.getPoliticalStatus());
		...
		this.ET_interest.setText(userInfo.getInterest());
		this.ET_introduce.setText(userInfo.getIntroduce());
	}
	@Override
