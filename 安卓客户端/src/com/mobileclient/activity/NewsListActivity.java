...
public class NewsListActivity extends Activity {
				...
				handler.post(new Runnable() {
					...
					public void run() {
						...
						adapter = new NewsSimpleAdapter(NewsListActivity.this, list,
	        					...
	        					new String[] { "title","newsDate","comeFrom" },
	        					new int[] { R.id.tv_title,R.id.tv_newsDate,R.id.tv_comeFrom,},lv);
	...
	private OnCreateContextMenuListener newsListItemListener = new OnCreateContextMenuListener() {
		public void onCreateContextMenu(ContextMenu menu, View v,ContextMenuInfo menuInfo) {
			menu.add(0, 0, 0, "编辑活动新闻信息"); 
			menu.add(0, 1, 0, "删除活动新闻信息");
		}
	};
	...
	public boolean onContextItemSelected(MenuItem item) {
		...
		} else if (item.getItemId() == 1) {// 删除活动新闻信息
			ContextMenuInfo info = item.getMenuInfo();
			AdapterContextMenuInfo contextMenuInfo = (AdapterContextMenuInfo) info;
			// 获取选中行位置
			int position = contextMenuInfo.position;
